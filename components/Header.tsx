...
function Header({ isFixed = false }: { isFixed?: boolean }) {
  return (
   ...
   <div className="max-w-7xl mx-auto px-4 xl:px-2 py-4 flex justify-between items-center">
    <Link href="/dashboard" className="text-2xl font-bold">Linkify</Link>
    <Authenticated>
    ...
    <Unauthenticated>
        <SignInButton mode="modal">
            <Button variant='outline' className="border-purple-600 text-purple-600 hover:border-purple-700 hover:bg-purple-600 hover:text-white transition-all duration-200">
